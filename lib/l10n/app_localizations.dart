...
abstract class AppLocalizations {
  ...
  /// Heading shown instead of the app when RootJailbreakDetector blocks launch on a rooted/jailbroken device.
  ///
  /// In en, this message translates to:
  /// **'This device failed a security check'**
  String get securityBlockedTitle;

  /// Body text under securityBlockedTitle explaining why the app refused to launch.
  ///
  /// In en, this message translates to:
