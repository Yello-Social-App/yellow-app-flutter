...
/// The profile screens' loading skeleton — a structural stand-in for the
/// whole `ListView` that `profile_page.dart` and `public_profile_page.dart`
/// build once the user is in, so the real page swaps in without anything
/// jumping. Replaces the centred `CircularProgressIndicator` both used to
/// show, which sat alone on an empty background and then cut to a full page.
///
/// Every measurement is copied from those two pages, which share one layout:
