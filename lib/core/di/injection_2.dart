...
void _registerCore() {
  ...
  sl.registerLazySingleton<TokenRefreshService>(
    () => TokenRefreshServiceImpl(sl()),
  );
  sl.registerLazySingleton<SessionManager>(
    () => SessionManagerImpl(sl(), sl(), sl()),
  );
  sl.registerLazySingleton<RootJailbreakDetector>(
    () => RootJailbreakDetectorImpl(),
  );
...
void _registerFeed() {
  ...
  sl.registerLazySingleton<FeedRepository>(
    () => FeedRepositoryImpl(sl(), sl(), sl(), sl()),
  );
